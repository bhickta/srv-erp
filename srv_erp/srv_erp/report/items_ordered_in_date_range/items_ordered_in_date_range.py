...
def get_columns(group_by_item=False):
	...
	return [
		...
		{"label": _("Stock UOM"), "fieldname": "uom_stock_qty", "fieldtype": "Link", "options": "UOM", "width": 90},
		{"label": _("Stock Qty Delivered"), "fieldname": "stock_delivered_qty", "fieldtype": "Float", "width": 130, "convertible": "qty"},
		{"label": _("Stock UOM"), "fieldname": "uom_stock_delivered_qty", "fieldtype": "Link", "options": "UOM", "width": 90},
		{"label": _("Stock Qty Pending"), "fieldname": "stock_pending_qty", "fieldtype": "Float", "width": 120, "convertible": "qty"},
		{"label": _("Stock UOM"), "fieldname": "uom_stock_pending_qty", "fieldtype": "Link", "options": "UOM", "width": 90},
