	...
	filters: [
		...
		},
		{
			...
			get_data: async function (txt) {
				...
				let exclude_disabled_items = frappe.query_report.get_filter_value("exclude_disabled_items");

				let filters = {
					...(item_group && { item_group }),
					...(exclude_disabled_items && { disabled: 0 }),
					is_stock_item: 1,
				};
		...
		{
			fieldname: "exclude_disabled_items",
			label: __("Exclude Disabled Items"),
			fieldtype: "Check",
			default: 1,
		},
		{
